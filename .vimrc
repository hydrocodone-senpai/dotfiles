...
autocmd FileType rmd inoremap ;x \textrm{<++>}<++><Esc>13hi
autocmd FileType rmd inoremap ;f \frac{<++>}{<++>}<++><Esc>17hi
autocmd Filetype rmd inoremap ;b **<++>**<++><Esc>12hi
autocmd Filetype rmd inoremap ;i *<++>*<++><Esc>10hi
autocmd Filetype rmd inoremap ;' '<++>',<++><Esc>11hi
autocmd Filetype rmd inoremap ;m $<++>$<++><Esc>10hi
